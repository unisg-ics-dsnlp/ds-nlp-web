...
[62] Thai, V. T., Davis, B., O'Riain, S., O'Sullivan, D., & Handschuh, S. (2008). Semantically Enhanced Passage Retrieval for Business Analysis Activity. *European Conference on Information Systems (ECIS).*

[63] Kim, A., Muhn, M., & Nikolaev, V. (2024). Financial Statement Analysis with Large Language Models. *Chicago Booth Research Paper (forthcoming); Fama-Miller Working Paper.*

[64] Meta. (2024). The Llama 3 Herd of Models. *Technical Report.*

[65] OpenAI. (2023). GPT-4 Technical Report. *arXiv.*
